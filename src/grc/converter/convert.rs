...
impl BlockConverter for ConvertBlockConverter {
    fn convert(
        ...
        let blk = match blk_id {
            "blocks_uchar_to_float" => TypeConvertersBuilder::scale_convert::<u8, f32>().build(),
            "blocks_char_to_float" => TypeConvertersBuilder::scale_convert::<i8, f32>().build(),
            "convert_s16_f" => TypeConvertersBuilder::scale_convert::<i16, f32>().build(),
            "blocks_float_to_uchar" => TypeConvertersBuilder::lossy_scale_convert_f32_u8().build(),
            "blocks_float_to_char" => TypeConvertersBuilder::lossy_scale_convert_f32_i8().build(),
            "blocks_float_to_short" => TypeConvertersBuilder::lossy_scale_convert_f32_i16().build(),
            "convert_ff_c" => {
