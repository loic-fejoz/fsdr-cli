...
pub trait LoadKissCmd<'i> {
    fn filename(&self) -> Result<&str>;
    fn build_load_kiss(&self, grc: GrcBuilder<GraphLevel>) -> Result<GrcBuilder<GraphLevel>>;
}

impl<'i> LoadKissCmd<'i> for Pair<'i, Rule> {
    ...
    fn build_load_kiss(&self, grc: GrcBuilder<GraphLevel>) -> Result<GrcBuilder<GraphLevel>> {
        ...
        grc = grc
            .create_block_instance("satellites_kiss_file_source")
