...
pub trait CsdrCmd<'i> {
    fn arg<'a, const N: usize>(&self, msg: impl Into<&'static str>) -> Result<&'i str>;
    fn type_arg<'a, const N: usize>(&self, msg: impl Into<&'static str>) -> Result<GrcItemType>;
    fn optional_arg<'a, const N: usize>(&self) -> Result<Option<&'i str>>;
}
